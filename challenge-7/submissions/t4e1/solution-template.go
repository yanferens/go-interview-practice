...
func (e *AccountError) Error() string {
	...
	return "Account error: " + e.Id + " owned by " + e.Owner
}
...
func (e *InsufficientFundsError) Error() string {
	// Implement error message
	return "Insufficient funds: minimum balance required is " + fmt.Sprintf("%.2f", e.MinBalance)
}
...
func (e *NegativeAmountError) Error() string {
	// Implement error message
	return "Negative amount error: " + fmt.Sprintf("amount cannot be negative: %.2f", e.Amount)
}
...
func (e *ExceedsLimitError) Error() string {
	// Implement error message
	return "Exceeds limit error: " + fmt.Sprintf("amount exceeds limit: %.2f", e.Amount)
}
